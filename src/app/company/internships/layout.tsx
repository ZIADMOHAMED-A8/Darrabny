...
export default function Layout({
  ...
  return (
    <>
    <div className="flex min-h-screen flex-col px-4 sm:px-6 lg:px-16">
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative z-50 max-h-[92vh] w-[920px] max-w-[95vw] overflow-y-auto rounded-[20px] shadow-2xl sm:rounded-[28px]">
